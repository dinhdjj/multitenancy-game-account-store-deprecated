...
return [
     ...
     */
    'cache' => [
        'tag_base' => env('TENANCY_CACHE_TAG_PREFIX', 'tenant-'), // This tag_base, followed by the tenant_id, will form a tag that will be applied on each cache call.
    ],
     ...
     */
    'redis' => [
        'prefix_base' => env('TENANCY_REDIS_PREFIX', 'tenant-'), // Each key in Redis will be prepended by this prefix_base, followed by the tenant id.
